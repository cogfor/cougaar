...
public class RobotProxy {
   ...
   */
  public void draw(RobotDemoPanel p, Graphics2D g2) {
    synchronized(p) {
  ...
  class LightCircle extends Arc2D.Double {
    ...
    public void draw_prev(RobotDemoPanel p, Graphics2D g2, AffineTransform at) {
      synchronized(p) {
      if (isLightOn()) {
        p.fill(this, g2, at);
      } else {
  ...
  class PictureAvailableRectangle extends Rectangle2D.Double {
    ...
    public void draw(RobotDemoPanel p, Graphics2D g2, AffineTransform at) {
      if (avail) {
        p.fill(this, g2, at);
      } else {
        p.draw(this, g2, at);
