 ...
 */
public class VoltageAllocatorPlugin extends SimplePlugin {
  ...
  protected void execute() {
    ...
    while (allos.hasMoreElements()) {
      ...
      System.out.println(Name+" is: "+ar.getValue(0));
      if (lf != null)
  ...
  private Task makeTask() {
    ...
    npp.setIndirectObject("Volts");
    prepositions.add(npp);

    npp = theLDMF.newPrepositionalPhrase();
    npp.setPreposition("Channel");
    npp.setIndirectObject("3");
    prepositions.add(npp);
